...
const GovernmentFeeScreen = () => {
  ...
  const handlePayment = () => {
    ...
    console.log(`Paying government fee for ${serviceType} with ${amount} BDT`);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Government Fee Payment</Text>
...
export default GovernmentFeeScreen;

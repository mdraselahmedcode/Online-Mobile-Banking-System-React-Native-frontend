...
const InternetBillScreen = () => {
  ...
  const handlePayment = () => {
    ...
    console.log(`Paying internet bill for account ${accountNumber} with ${amount} BDT`);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Internet Bill Payment</Text>
...
export default InternetBillScreen;
